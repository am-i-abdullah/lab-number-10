...
public interface Expression {
    ...
    /**
     * Creates an empty expression such that
     * Expression.parse("0").equals(emptyExpression())
     */
     ...
     *         If e equals Expression.emptyExpression(), correct to 5 decimal
     *         places,
     *         the empty expression is returned;
     *         The expression is not simplified
     */
     ...
     *         places,
     *         the empty expression is returned;
     *         - If e equals Expression.parse("1"), correct to 5 decimal places,
     *         this
     *         expression is returned
     ...
     * If the substituted polynomial is a constant expression, with no variables
     * remaining,
     * then simplification reduces it to a single number, with no operators
     * remaining.
     * 
     ...
     * - those variables, numbers, and operators are in the same order, read
     * left-to-right;
     ...
     * However, two products are NOT equal if they have different groupings
     * regardless
